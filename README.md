...
- **Симметричный зуб** (для 33 — это 43) находится на скане челюсти,
  ...
  размера и высоты коронки. Его поверхность переносится в полном
  разрешении (валики, доли, бороздки, стираемость), без огрубления.
...
| + поверхность 43 в полном разрешении | **0,45 мм** | **0,89 мм** |
