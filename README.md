...
- **Симметричный зуб** (для 33 — это 43) находится на скане челюсти,
  зеркально отражается и ставится на место препарирования — это шаблон формы,
  размера и высоты коронки.
...
Ограничение: это «среднеанатомический артикулятор» в системе координат
зуба, без переноса лицевой дугой; углы задают допустимую крутизну,
а не строят ведущую поверхность клыка заново.
